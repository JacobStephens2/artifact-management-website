...
<div ID="content">
  ...
  <li><a class="back-link" href="<?php echo url_for('/games/playby.php'); ?>">&laquo; To play games by date list</a></li>
  ...
  <div class="object edit">
    ...
    <form action="<?php echo url_for('/games/playgroup-edit.php?ID=' . h(u($ID))); ?>" method="post">
    <dl>
        <dt>Player</dt>
        <dd>
